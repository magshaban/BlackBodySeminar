...
\subsection{The blackbody problem}
...
\subsection{The ultraviolet catastrophy} 
...
\subsection{Planck's empirical formula}
...
\begin{frame}
		...
		\[ Y = \dfrac{1}{(1 - x )^2 } \]
		 ...
		 Average energy \[  \left< E \right> = \dfrac{ N_0 \hbar \omega x / (1 - x )^2}{ N_0 / (1 - x )} \] %not aligned properly
\end{frame}
...
\subsection{Intensity of a blackbody spectrum and the problem}
...
\begin{frame}{}
	...
	\begin{center}
		...
		{\large Einstein considered that even the light was quantised and considerd it to be made up of photons with energy $\hbar \omega$  }  
	 		...
	 		\includegraphics[scale=0.1]{emission.jpg}
...
\begin{frame}{}
	...
	\columnbreak
		...
		\includegraphics[scale=0.15]{detectorA.jpg} 
